...
public class LoginAuthenticationFilter extends AuthenticationProcessingFilter {
  ...
  public Authentication attemptAuthentication(HttpServletRequest request)
    ...
    String wemall_view_type = CommUtil
        .null2String(request.getSession(false).getAttribute("wemall_view_type"));
    ...
    if (session.getAttribute("verify_code") != null) {
      String code =
          request.getParameter("code") != null ? request.getParameter("code").toUpperCase() : "";
  ...
  protected void onSuccessfulAuthentication(HttpServletRequest request,
    ...
    request.getSession().setAttribute("username",obtainUsername(request));
