...
public class LuceneVo {
    ...
    public static final String GOODS_CURRENT_PRICE = "goods_current_price";
	...
	public void setVo_goods_current_price(double vo_goods_current_price) {
		this.vo_goods_current_price = vo_goods_current_price;
	}
}
