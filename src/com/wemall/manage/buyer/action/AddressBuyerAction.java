...
public class AddressBuyerAction {
    ...
    @SecurityMapping(display = false, rsequence = 0, title = "收货地址AJAX更新", value = "/buyer/address_ajax.htm*", rtype = "buyer", rname = "用户中心", rcode = "user_center", rgroup = "用户中心")
	@RequestMapping({ "/buyer/address_ajax.htm" })
	public void ajax(HttpServletRequest request, HttpServletResponse response, String id, String fieldName,
			String value) throws ClassNotFoundException {
    	Address obj = addressService.getObjById(Long.valueOf(Long.parseLong(id)));
