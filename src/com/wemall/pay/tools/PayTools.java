...
public class PayTools {
    ...
    public String genericgdcard(String url, String payment_id, String type, String id)
...
//        String product_name = of.getOrder_id();
        ...
        billCore.clearParameter();
        billCore.setParameter("transId", "IPER");
        billCore.setParameter("merchantId", "370310000004");//399110000003
        billCore.setParameter("orderId", id);
        billCore.setParameter("transAmt", String.valueOf(fee));
        billCore.setParameter("transDateTime", transDateTime);
        billCore.setParameter("currencyType", "01");
        billCore.setParameter("customerName", customerName);
        billCore.setParameter("merSecName", "锡好");
        billCore.setParameter("productInfo", desc);
        billCore.setParameter("merURL", url + "/gdpay_return.htm");
        billCore.setParameter("merURL1", url + "/gdpay_return.htm");
        billCore.setParameter("msgExt", "锡好");

        String result = BillService.buildForm_gd(billCore.createSign_gd(), "post", "确定");
        return result;
    }
