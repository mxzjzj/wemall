 ...
 */
@Controller
public class LaoZiHaoViewAction {
	...
	@RequestMapping({ "/index_laozihao.htm" })
	public ModelAndView index_nongye(HttpServletRequest request, HttpServletResponse response) {
		ModelAndView mv = new JModelAndView("index_laozihao.html", this.configService.getSysConfig(),
	...
	@RequestMapping({ "/floor_laozihao.htm" })
	...
	@RequestMapping({ "/wap/index_laozihao.htm" })
	public ModelAndView wap_index_nongye(HttpServletRequest request, HttpServletResponse response) {
		...
		if ((wemall_view_type != null) && (!wemall_view_type.equals("")) && (wemall_view_type.equals("wap"))) {
			mv = new JModelAndView("wap/index_laozihao.html", this.configService.getSysConfig(),
					this.userConfigService.getUserConfig(), 1, request, response);
		}
		return mv;
	}

	@RequestMapping({ "/wap/floor_laozihao.htm" })
